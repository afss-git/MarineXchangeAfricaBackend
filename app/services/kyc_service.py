...
async def verify_document(
    ...
    *,
    ...
    # Check if this agent already verified this document (table is immutable — no updates allowed)
    existing = await db.fetchrow(
        "SELECT * FROM kyc.document_verifications WHERE document_id = $1 AND verified_by = $2",
