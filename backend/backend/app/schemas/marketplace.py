...
class PublicProductDetailResponse(ProductDetailResponse):
    """Buyer-facing product detail — exact address hidden for security."""
    location_port:    None = None
    location_details: None = None
